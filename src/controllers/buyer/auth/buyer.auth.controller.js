...
import {
  createBuyerSession,
  deleteBuyerSession,
} from "../../../sessions/buyer.auth.session.js";
  ...
  try {
    ...
    if (existingBuyer.is_active === false) {
      return res.status(403).json({
        success: false,
        error: [
          "This account has been migrated to the Industrial Ecosystem. Please use the Industrial Login portal.",
        ],
      });
    }
