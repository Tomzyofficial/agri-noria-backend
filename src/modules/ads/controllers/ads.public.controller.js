...
//       return res
//         .status(500)
//         .json({ success: false, error: "Failed to load campaigns" });
//     }
//   },
...
//         return res
//           .status(400)
//           .json({ success: false, error: "country query is required" });
//       }
...
//       return res
//         .status(500)
//         .json({ success: false, error: "Failed to load catalog" });
//     }
//   },
// };
